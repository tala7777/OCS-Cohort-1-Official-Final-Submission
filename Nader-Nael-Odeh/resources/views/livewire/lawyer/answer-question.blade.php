<div>
 <div class="card mb-4 shadow-sm">
    ...
    <div class="card shadow-sm">
        <div class="card-header py-3">
            <h5 class="mb-0"><i class="fas fa-pen me-2 text-success"></i>Draft Your Answer</h5>
        </div>
        <div class="card-body">
            <form wire:submit.prevent="store">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('lawyer.questions.index') }}" class="btn btn-outline-secondary px-4">Cancel</a>
